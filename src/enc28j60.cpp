...
void ENC28J60::clearWOLInterrupt () {
    writeOp(ENC28J60_BIT_FIELD_CLR, EWOLIR, EWOLIR_MPWOLIF);
    writeOp(ENC28J60_BIT_FIELD_CLR, EIR, EIR_WOLIF);
}

bool ENC28J60::pollWOLInterrupt () {
   if((readRegByte(EWOLIR) & (EWOLIR_MPWOLIF)) == EWOLIR_MPWOLIF)
   {
      return true;
   }
   else
